...
?>
<div
	class="cart_totals cart-summary p-3 sidebar <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<h5 class="section-title"><span><?php esc_html_e( 'Cart totals', 'woocommerce' ); ?></span></h5>
